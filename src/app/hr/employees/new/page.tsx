    ...
    return (
      <div className="flex flex-col items-center justify-center py-32 gap-6 animate-fade-in">
        ...
        <div className="text-center space-y-2">
          <h3 className="text-2xl font-black uppercase tracking-tight">Identity Enrolled</h3>
      ...
      <div className="sticky top-14 z-[100] bg-background/80 backdrop-blur-xl -mx-4 md:-mx-6 px-4 md:px-6 py-4 mb-2 border-b border-white/5 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="space-y-1">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-xl font-black tracking-tight uppercase bg-gradient-to-r from-primary via-primary/80 to-secondary bg-clip-text text-transparent leading-none">Enroll Associate</h2>
          </div>
          <p className="text-[10px] text-muted-foreground/60 font-black uppercase tracking-widest italic pl-16">Human Resource & Infrastructure Provisioning</p>
        </div>
          ...
          <div className="premium-card p-6 rounded-[32px] border border-white/5 bg-card/40 relative group">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 relative z-10">
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/60 ml-1">Full Legal Name</label>
                <div className="relative group/field">
                  ...
                  <input 
                    ...
                    className="w-full bg-muted/10 border border-border/40 focus:border-primary/40 rounded-2xl pl-12 pr-6 py-3.5 text-xs outline-none transition-all font-bold placeholder:font-normal placeholder:opacity-20" 
                  />
                </div>
              </div>

              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/60 ml-1">Employee ID Card</label>
                <div className="relative group/field">
                  ...
                  <input 
                    ...
                    className="w-full bg-muted/10 border border-border/40 focus:border-primary/40 rounded-2xl pl-12 pr-6 py-3.5 text-xs outline-none transition-all font-black tracking-widest font-mono" 
                  />
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="premium-card p-6 rounded-[32px] border border-white/5 bg-card/40 relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 relative z-10">
                 ...
                 <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/60 ml-1">Preferred Corp Email</label>
                    <div className="relative group/field">
        ...
        <div className="xl:col-span-4 sticky top-10 flex flex-col items-center gap-8">
            ...
            <div className="w-full max-w-[340px] bg-card/60 dark:bg-[#0A0A0A] backdrop-blur-3xl rounded-[48px] border border-black/5 dark:border-white/10 shadow-[0_64px_128px_-16px_rgba(0,0,0,0.1)] dark:shadow-[0_64px_128px_-16px_rgba(0,0,0,0.8)] relative overflow-hidden flex flex-col group/id transition-all duration-500">
               ...
               <div className="p-10 pb-6 relative z-10 text-center space-y-6">
                  ...
                  <div className="space-y-1">
                     <p className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/40">Joining Associate</p>
               ...
               <div className="px-10 pb-8 space-y-4 relative z-10">
                  ...
                  <div className="space-y-3">
                     <p className="text-[9px] font-black uppercase tracking-[0.2em] text-muted-foreground/30 text-center italic">Provisioning Stack</p>
                     <div className="flex justify-center -space-x-2.5">
                        {provisions.laptop && (
                          <div className="w-10 h-10 rounded-2xl bg-primary text-white flex items-center justify-center border-[3px] border-card dark:border-[#0A0A0A] shadow-2xl"><Laptop className="w-4 h-4" /></div>
                        )}
                        {provisions.email && (
                          <div className="w-10 h-10 rounded-2xl bg-primary text-white flex items-center justify-center border-[3px] border-card dark:border-[#0A0A0A] shadow-2xl"><Mail className="w-4 h-4" /></div>
                        )}
                        {provisions.phone && (
                          <div className="w-10 h-10 rounded-2xl bg-primary text-white flex items-center justify-center border-[3px] border-card dark:border-[#0A0A0A] shadow-2xl"><Smartphone className="w-4 h-4" /></div>
                        )}
                     </div>
                  </div>
               </div>
               ...
               <div className="mt-auto bg-primary/5 p-8 border-t border-black/5 dark:border-white/5 flex flex-col items-center gap-4">
                  <div className="flex items-center gap-3">
                     ...
                     <div className="space-y-0.5">
                        ...
                        <p className="text-[10px] font-black text-primary/60 italic uppercase tracking-tighter">Awaiting Onboarding</p>
                     </div>
                  </div>
