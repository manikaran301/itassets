  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-3xl font-bold tracking-tight bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Employee Exits</h2>
          <p className="text-muted-foreground mt-1">Offboarding tracking for hardware recovery and identity deactivation.</p>
        </div>
