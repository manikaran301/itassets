                ...
                <div className="flex gap-2">
                  <div className="flex-1 relative group/field">
                    ...
                    <input
                      ...
                      onKeyDown={(e) =>
                        e.key === "Enter" &&
                        (e.preventDefault(), addForwarding())
                      }
                ...
                <div className="max-h-[80px] overflow-y-auto pr-1 space-y-1.5 scrollbar-hide">
                  {forwardingAddresses.length > 0 ? (
                    forwardingAddresses.map((addr) => (
                      <div
                        key={addr}
                        className="flex items-center justify-between px-3 py-1.5 bg-primary/5 border border-primary/10 rounded-xl animate-fade-in group/item"
                      >
