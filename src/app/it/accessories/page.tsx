      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-fade-in delay-100">
        {accessories.map((acc) => {
          ...
          return (
            <div
              key={acc.id}
              className="premium-card rounded-2xl overflow-hidden glass border-border/50 group flex flex-col h-full bg-card/60"
            >
              <div className="p-6 space-y-4 flex-1">
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-sm font-bold tracking-tight uppercase group-hover:text-primary transition-colors">
                        {acc.assetTag}
                      </h4>
                      <p className="text-[10px] text-muted-foreground italic tracking-tight">
                        {prettyType}
                      </p>
                    </div>
                  </div>
