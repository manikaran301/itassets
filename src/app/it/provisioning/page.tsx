      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-fade-in delay-100">
        {requests.map((req) => {
          ...
          return (
            <div
              key={req.id}
              className="premium-card rounded-2xl overflow-hidden glass group flex flex-col h-full bg-card/60 relative"
            >
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="text-sm font-bold uppercase tracking-widest text-muted-foreground">
                      Request {req.requestCode}
                    </h4>
                    <p className="text-lg font-bold tracking-tight h-14 line-clamp-2">
                      Provisioning for {req.employee.fullName}
                    </p>
                  </div>
