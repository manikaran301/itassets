      ...
      <div className="flex items-center justify-between rounded-2xl border border-border bg-card/50 backdrop-blur-xl px-6 py-4 shadow-sm">
        <div>
          ...
          <div className="flex items-baseline gap-2">
            <h1 className="text-2xl font-black tracking-tighter">{totalLogs}</h1>
            <span className="text-[10px] font-bold text-muted-foreground/40 uppercase">Total entries</span>
          </div>
        </div>
        <div className="text-right">
          <p className="text-xs font-bold text-primary">Live stream</p>
          <p className="text-[9px] font-medium text-muted-foreground uppercase tracking-widest leading-none">Latest 50 updates</p>
        </div>
      </div>
